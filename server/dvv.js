...
// Length of each partition (default set to 1) for function requiring more than one input parameter
// Define each set of arguments in an array and set PARTITION_LENGTH = 0
...
var CLOCK = false; // Set a timer to measure the duration of entire distributed task - For testing purposes
var dvv = {}; // Define export dvv object
...
dvv.start = function(){
  ...
  io.of('/').on('connection', function(socket){
    ...
    // When client has returned data, check validity and send another packet if necessary
    socket.on('completed', function(data){

      // If the computation was completed successfully and it was delivered back in a timely fashion,
